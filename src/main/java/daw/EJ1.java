...
public class EJ1 {
 ...
 /*genero un array con el metodo rellenaArray*/
        ...
        int pos = numSpecifico(arrayDeNumAleatorios, numEspecifico);
        if (pos != 504) {/*504 por que es mi valor por defecto si no se encuentra la
            posición específica*/
    ...
    public static int numSpecifico(int[] array, int num) {
        /*posiciones*/
        int mitad = 0;
        int izquierda = 0;
